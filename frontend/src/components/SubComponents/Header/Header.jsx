...
const Header = () => {
  return (
    <div className="head">
      ...
      <div className="intro">
        <h1>Savor the Moment with Hot and Delicious <span style={{color: 'yellow', fontFamily: 'Ojuju'}}>Kenkey</span> - <span style={{color: 'red', fontFamily: 'Ojuju'}}>Fast Delivery </span> to Your Doorstep!</h1>
